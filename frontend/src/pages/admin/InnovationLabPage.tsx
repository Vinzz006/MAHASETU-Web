...
const MODULES: Record<string, LabModule[]> = {
  "Governance & Executive": [
    ...
    { id: "master", title: "Master Showcase Hub", subtitle: "Complete end-to-end 15-phase platform simulation", route: "/admin/capstone-showcase", icon: Cpu, color: "text-amber-700", bgColor: "bg-amber-50", borderColor: "border-amber-300", tags: ["Phase 10", "Demo", "Capstone"], phase: 10 },
  ],
