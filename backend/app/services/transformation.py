...
class DataTransformationEngine:
    ...
    def to_canonical_from_soap_xml(cls, xml_payload: str) -> dict[str, Any]:
        ...
        try:
            ...
            name = (
                find_text("CitizenName")
                or find_text("BeneficiaryName")
                or find_text("Name", "Demo Citizen")
            )
    ...
    @classmethod
    def from_canonical_to_soap_xml(
        cls,
        canonical: dict[str, Any],
        root_element: str = "CitizenVerificationRequest",
    ) -> str:
        ...
        xml = (
            ...
            '<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:mh="http://mahasetu.gov.in/interop">\n'
            "  <soap:Header/>\n"
            "  <soap:Body>\n"
            f"    <mh:{root_element}>\n"
    ...
    def dynamic_transform(
        cls, source_payload: dict[str, Any], mapping_rules: dict[str, str]
    ) -> dict[str, Any]:
        """
    ...
    def trace_transformation(
        ...
        if source_dept == "DEPT_A":
            ...
            canonical = (
                ...
                else cls.to_canonical_from_legacy(str(raw_input))
            )
