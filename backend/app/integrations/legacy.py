...
class LegacyDepartmentConnector(DepartmentConnector):
    ...
    def verify_identity(self, citizen_canonical: Dict[str, Any]) -> Dict[str, Any]:
        ...
        legacy_stream = DataTransformationEngine.from_canonical_to_legacy(citizen_canonical)
        ...
        parsed_canonical = DataTransformationEngine.to_canonical_from_legacy(legacy_stream)
    ...
    def submit_application(self, application_canonical: Dict[str, Any]) -> Dict[str, Any]:
        legacy_stream = DataTransformationEngine.from_canonical_to_legacy(application_canonical)
        return {
            "department_id": self.department_id,
