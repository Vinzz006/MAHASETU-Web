...
class Grievance(Base):
    ...
    ticket_number = Column(String(64), unique=True, nullable=False, index=True) # e.g. MH-GRV-2026-00412
    ...
    category = Column(String(100), nullable=False) # IDENTITY_MISMATCH, ELIGIBILITY_DISCREPANCY, SANCTION_DELAY, TECHNICAL_EXCEPTION
    description = Column(Text, nullable=False)
    status = Column(String(50), nullable=False, default="OPEN") # OPEN, INVESTIGATING, ESCALATED, RESOLVED
