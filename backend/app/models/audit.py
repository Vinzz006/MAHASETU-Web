...
class AuditLog(Base):
    ...
    action = Column(String(100), nullable=False) # APPLICATION_CREATED, CONSENT_REQUESTED, CONSENT_GRANTED, DEPT_A_CALLED, etc.
    resource = Column(String(100), nullable=False) # e.g. APPLICATION, CONSENT, CONNECTOR_DEPT_A, WORKFLOW
