...
class SLAEscalation(Base):
    ...
    severity = Column(String(50), nullable=False, default="APPROACHING_BREACH") # APPROACHING_BREACH, BREACHED
    escalation_level = Column(String(50), nullable=False, default="DISTRICT_OFFICER") # DISTRICT_OFFICER, HEAD_OF_DEPARTMENT, STATE_DIRECTOR
    escalated_to = Column(String(255), nullable=False, default="District Employment Officer, Pune")
    status = Column(String(50), nullable=False, default="PENDING_EXPEDITE") # PENDING_EXPEDITE, EXPEDITED, RESOLVED
