...
class Application(Base):
    ...
    workflow_steps = relationship("WorkflowStep", back_populates="application", cascade="all, delete-orphan")
    transactions = relationship("DepartmentTransaction", back_populates="application", cascade="all, delete-orphan")
