...
router = APIRouter(prefix="/api/field", tags=["Talathi & Gram Sevak Field Verification"])
...
class FieldInspectionRequest(BaseModel):
    ...
    recommendation: str = "RECOMMENDED_FOR_SANCTION"  # "RECOMMENDED_FOR_SANCTION", "REJECTED_LAND_DISPUTE"
...
def submit_field_inspection(req: FieldInspectionRequest):
    ...
    record = {
        ...
        "edge_sync_status": "INGESTED_VIA_GRAMIN_EDGE" if req.offline_sync_queued else "DIRECT_ONLINE"
    }
