...
router = APIRouter(
    prefix="/api/dpdp-erasure",
    tags=["MahaNirasana — DPDP Right-to-be-Forgotten & Privacy Ledger"],
)
...
DEPARTMENT_PRIVACY_FOOTPRINT = [
    ...
    },
    {
        ...
        "held_attributes": [
            "Annual Income Certificate Extract",
            "7/12 Agricultural Land Holding",
    ...
    },
    {
        ...
        "held_attributes": [
            ...
            "IFSC Code",
            "DBT Transaction Cryptographic Receipt",
        ],
...
class ErasureRequest(BaseModel):
    ...
    reason: str = (
        "Service application completed; exercising statutory Right to be Forgotten under DPDP Act 2023."
    )
...
def execute_right_to_be_forgotten(req: ErasureRequest):
    ...
    digest = hashlib.sha256(
        f"{erasure_tx}:{req.citizen_mobile}:{now_iso}".encode()
    ).hexdigest()
