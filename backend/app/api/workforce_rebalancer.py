...
router = APIRouter(prefix="/api/workforce", tags=["MahaKarma — AI Workforce & Desk Workload Rebalancer"])
...
def get_officer_workload():
    ...
    return {
        ...
        "total_pending_desk_files": sum(o["pending_files"] for o in TALUKA_OFFICER_DESK_TELEMETRY),
        "average_backlog_per_officer": round(sum(o["pending_files"] for o in TALUKA_OFFICER_DESK_TELEMETRY) / len(TALUKA_OFFICER_DESK_TELEMETRY), 1),
